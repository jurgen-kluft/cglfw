...
#include "cglfw/null_platform.h"
#define GLFW_EXPOSE_NATIVE_EGL
#define GLFW_EXPOSE_NATIVE_OSMESA

#if defined(_GLFW_WIN32)
 #include "cglfw/win32_platform.h"
 ...
 #include "cglfw/cocoa_platform.h"
...
#include "cglfw/null_joystick.h"

#if defined(_GLFW_WIN32)
 #include "cglfw/win32_joystick.h"
#else
...
#if defined(_GLFW_COCOA)
 #include "cglfw/cocoa_joystick.h"
#else
 ...
 #include "cglfw/linux_joystick.h"
#else
